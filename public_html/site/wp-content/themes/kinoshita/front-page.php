...
<main id="siteContent" role="main">
					...
					<div class="_content">
						<div class="__txt">
							...
							<a href="<?php echo home_url();
												echo '/business'; ?>" class=" button color">
								<span>事業内容</span>
								<i><img src="<?php bloginfo('template_url'); ?>/images/icon/arrow_wh.svg" class="objf"></i>
							</a>
						</div>
	...
	<section>
		<?php if (!wp_is_mobile()) : ?>
			<a href="https://kinoshitafe26.com/good-design2024">
				<img src="<?php bloginfo('template_url'); ?>/images/gd_bannar.png" alt="">
			</a>
		<?php else : ?>
			<a href="https://kinoshitafe26.com/good-design2024">
				<img src="<?php bloginfo('template_url'); ?>/images/gd_bannar_sp.png" alt="">
			</a>
		<?php endif; ?>
	</section>
</main><!-- #site-content -->
